    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rent', models.DecimalField(decimal_places=2, default=0, max_digits=7)),
                ('total_price', models.DecimalField(decimal_places=2, max_digits=7)),
                ('distance', models.DecimalField(decimal_places=2, default=0, max_digits=4)),
                ('furnished', models.CharField(default='', max_length=3)),
                ('parking', models.CharField(default='', max_length=20)),
